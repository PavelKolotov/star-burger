...
```
В [кабинете разработчика](https://developer.tech.yandex.ru/) в API JavaScript API и HTTP Геокодер получите ключ. В созданном файле `.env`  добавьте `YANDEX_GEOCODER_API_KEY`:
```sh
YANDEX_GEOCODER_API_KEY=4b6fc4ca-85a5-...
```
